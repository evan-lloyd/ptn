...
disp(['Consider a 1D system of spins with nearest neighbor interaction' ...
      ' and periodic boundary conditions (example from Huckle et' ...
      ' al., Computations in Quantum Tensor Networks):'])
disp(['P x P x I x ... x I + I x P x P x I x ... x I + ... ' ...
      '+ I x ... x P x P + P x I x ... x I x P.']); disp(' ');
...
core_exact = htensor(core.children, core.dims, U, B);
