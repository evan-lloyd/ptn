function example_basics()
%EXAMPLE_BASICS Demonstration of basic htensor functionality.
%
%   See also HTENSOR.
...
disp('norm_nd( full(Ax) - ttm(full(x), A, 2) )');
norm_nd(full(Ax) - ttm(full(x), A, 2))
keyboard
...
disp(['In contrast to truncate, truncate_sum avoids the fill-in' ...
...
disp(['Successive truncation is the fastest for bigger sizes, but' ...
