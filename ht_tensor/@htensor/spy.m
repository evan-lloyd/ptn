...
%
%   SPY(X, [OPTS]) plots the dimension tree of htensor X, with the
%   spy plots of matrix U on each leaf node / spy3 plots of
%   tensor B on each non-leaf node.
%
%   The optional argument OPTS can be used to change the plot
%   orientation:
%   OPTS.PORTRAIT: {TRUE} | FALSE
%
%   A new figure is generated, with (optional) title OPTS.TITLE.
%
%   See also: HTENSOR/PLOT_SV
