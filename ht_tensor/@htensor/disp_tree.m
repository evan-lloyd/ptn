function disp_tree(x, name, v)
%DISP_TREE Command window display of an htensor's structure.
%
%   DISP_TREE(H) displays the structure of an htensor with no name.
%
%   DISP_TREE(H,NAME) displays the structure of an htensor with the given name.
%
%   DISP_TREE(H,NAME,V) displays the structure of an htensor with the given
%   name, and appends v(i) to node i.
%
%   See also DISP, HTENSOR/DISPLAY, HTENSOR
