function [ figures ] = plot_ptn_learn_iter_parm_KL( resultsPath, qName, yRange )
            ...
            for j=1:numRes
                ...
                for k=1:numSamplePoints
                    ...
                    [thisKL{:}] = results([results.target] == targetTypes(i) ...
                        ...
                        & [results.res] == testDesc.res(j)).iterParameterKL;
